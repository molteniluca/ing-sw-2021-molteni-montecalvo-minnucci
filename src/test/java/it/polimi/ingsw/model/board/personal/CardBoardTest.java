...
public class CardBoardTest extends TestCase {
    ...
    public void testGetDevelopmentCards() {
        ...
        try {
            cb.insertCard(new DevelopmentCard(13,new Resources(),'b',1,new Resources(),new Resources()),0);
            cb.insertCard(new DevelopmentCard(13,new Resources(),'b',2,new Resources(),new Resources()),0);
            cb.insertCard(new DevelopmentCard(13,new Resources(),'b',1,new Resources(),new Resources()),1);
            cb.insertCard(new DevelopmentCard(13,new Resources(),'b',1,new Resources(),new Resources()),2);
            cb.insertCard(new DevelopmentCard(13,new Resources(),'b',3,new Resources(),new Resources()),2);
