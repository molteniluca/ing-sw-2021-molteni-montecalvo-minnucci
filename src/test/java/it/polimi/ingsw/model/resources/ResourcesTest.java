...
public class ResourcesTest extends TestCase {
    ...
    public void testAdd() {
        ...
        assert resources.getResourceNumber(ResourceTypes.STONES)==10;
    ...
    public void testSub() {
        ...
        assert diff.getResourceNumber(ResourceTypes.STONES) == 0;
    ...
    public void testNegativeSubValues() {
        ...
        Resources resources2= new Resources();
        resources2.set(ResourceTypes.BLANK,90);
        resources2.set(ResourceTypes.STONES,3);
        ...
        assert resources.getResourceNumber(ResourceTypes.STONES)==0;
    }
